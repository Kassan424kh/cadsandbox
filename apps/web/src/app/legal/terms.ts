...
import { LEGAL, LIMITS } from '@cadsandbox/shared'
...
export const terms: LegalSet = {
    ...
    sections: [
      {
        ...
        body: ['Diese Bedingungen gelten für die Nutzung von CadSandbox, angeboten von {op:name}, {op:street}, {op:postalCity} („wir“). Abweichende Bedingungen von Nutzerinnen und Nutzern gelten nicht.'],
      },
      {
        ...
        body: [
          ...
          'Kostenpflichtige Tarife, Speicherkontingente und Preise: Die Nutzung ist derzeit kostenlos.',
        ],
      },
      {
        heading: '3. Konto',
        body: [`Sie müssen bei der Registrierung wahre Angaben machen, Ihre Zugangsdaten geheim halten und uns über Missbrauch informieren. Ein Konto ist nicht übertragbar. Die Nutzung ist ab ${LEGAL.minAge} Jahren erlaubt.`],
      },
      {
      ...
      },
      {
        ...
        body: [`Sie können Ihr Konto jederzeit im Datenschutz-Center löschen; nach einer Wartefrist von ${LIMITS.accountDeletionGraceDays} Tagen werden alle Daten endgültig gelöscht. Wir können den Vertrag mit einer Frist von 4 Wochen kündigen; das Recht zur außerordentlichen Kündigung bleibt unberührt.`],
      },
      {
        heading: '8. Haftung',
        body: [
      ...
      },
      {
        ...
        body: ['Wir können diese Bedingungen mit Wirkung für die Zukunft ändern. Über Änderungen informieren wir mindestens 4 Wochen vorher per E-Mail; widersprechen Sie nicht, gelten die Änderungen als angenommen. Auf dieses Widerspruchsrecht weisen wir in der Mitteilung hin.'],
      },
      {
        ...
        body: [
          ...
          'Gerichtsstand für Kaufleute ist der Sitz des Anbieters. Sollte eine Bestimmung unwirksam sein, bleibt der Vertrag im Übrigen wirksam.',
        ],
      },
    ],
  },
  en: {
    ...
    sections: [
      { heading: '1. Scope', body: ['These terms govern the use of CadSandbox, provided by {op:name}, {op:street}, {op:postalCity} (“we”). Conflicting terms of users do not apply.'] },
      {
        heading: '2. Services',
        body: [
          ...
          'Paid plans, storage quotas and prices: Use is currently free of charge.',
        ],
      },
      { heading: '3. Account', body: [`You must provide truthful information, keep your credentials secret and tell us about misuse. Accounts are not transferable. Minimum age: ${LEGAL.minAge}.`] },
      {
      ...
      },
      {
        ...
        body: [`You can delete your account at any time in the privacy center; after a ${LIMITS.accountDeletionGraceDays}-day grace period all data are permanently deleted. We may terminate with 4 weeks’ notice; the right to terminate for cause remains unaffected.`],
      },
      {
        heading: '8. Liability',
        body: [
      ...
      },
      {
        ...
        body: ['We may change these terms for the future. We will notify you by email at least 4 weeks in advance; if you do not object, the changes are deemed accepted. The notice will point out this right to object.'],
      },
      {
        ...
        body: [
          ...
          'Place of jurisdiction for merchants: the provider’s place of business. If a provision is invalid, the remainder of the contract stays in effect.',
        ],
      },
    ],
  },
