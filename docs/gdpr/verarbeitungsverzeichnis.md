...
| 10 | Datensicherung | Wiederherstellbarkeit (Art. 32 (1) c) | Art. 6 (1) f | alle | Datenbank-Dump und Dateien, clientseitig verschlüsselt (restic / rclone-crypt) — der Anbieter erhält nur Chiffrat | Backup-Speicher: zweiter EU-Anbieter, separates Konto (siehe subprocessors.md) | Dumps 7 täglich / 4 wöchentlich / 6 monatlich; gelöschte Dateien nach 190 Tagen aus der Spiegelkopie entfernt (max. ≈ 6 Monate) |
