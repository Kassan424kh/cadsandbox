...
export const COMMAND_INFO: Record<CommandId, Info> = {
  ...
  'object.lock': { label: 'Lock', category: 'Object', shortcut: 'Shift+L', icon: 'lock' },
  ...
  'transform.rotate90': { label: 'Rotate 90°', category: 'Transform', shortcut: 'Shift+R', icon: 'rotate-cw-square' },
